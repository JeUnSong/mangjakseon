        ...
        success: function(data){
            ...
            data.results.forEach((item)=>{
                list.push([
                    ...
                    str += `<input type="checkbox" class="dataId" name="movieTitle" value=${item.title} checked>`,
                    str += `<input type="checkbox" class="dataId" name="movieOverview" value=${item.overview} checked>`,
                    str += `<input type="checkbox" class="dataId" name="movieReleaseDate" value=${item.release_date} checked>`,
                    str += `<input type="checkbox" class="dataId" name="moviePoster" value=${item.poster_path} checked>`,
                    str += `<input type="checkbox" class="dataId" name="movieBackdrop" value=${item.backdrop_path} checked>`,
                    str += '</div>',
                    str += '</form>',
