...
1. 1400px 까지의 반응형 적용
2. 임시 비밀번호 전송 적용 완료
3. 회원 수정 페이지 비밀번호 부분 삭제 후 항해중 메시지 추가

3차 배포 후 결함 및 개선 필요 사항
1. 회원 탈퇴 및 프로필 수정 안됨 (윈도우에선 됨)
2. 이미지 경로 설정 안됨 (프로필, 게시판 둘다)
3. index, movie, 망작선 점수 및 리스트 간혈적으로 안뜸
4. 767px 이하 (모바일) 반응형 필요
5. 리뷰 작성 시 XSS 공격 방어 필요
-------------------------------------------------
...
# 08.07 변경 사항
1. 1400px 까지의 반응형 추가
2. 회원 수정 페이지 비밀번호 부분 삭제 후 항해중 메시지 추가
